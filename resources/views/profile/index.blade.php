                        ...
                        @else
                            <div class="alert alert-danger p-2 m-2">
                                <h5><i class="icon fas fa-exclamation-circle"></i>{{ __('Required Discord verification!') }}</h5>
									...
									{{ __('It looks like this hasn\'t been set-up correctly! Please contact support.') }}
                            </div>
                        @endif
                    @endif
                                    ...
                                    <div class="text-center text-sm-left mb-2 mb-sm-0"><h4
                                        ...
                                        <p class="mb-0">{{$user->email}}
                                            @if($user->hasVerifiedEmail())
                                                <i data-toggle="popover" data-trigger="hover" data-content="{{ __('Verified') }}" class="text-success fas fa-check-circle"></i>
                                            @else
                                                <i data-toggle="popover" data-trigger="hover" data-content="{{ __('Not verified') }}" class="text-danger fas fa-exclamation-circle"></i>
                                            @endif
                                ...
                                <div class="tab-pane active">
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-sm-6 mb-3">
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <div class="form-group"><label>{{ __('Confirm') }} <span class="d-none d-xl-inline">{{ __('Password') }}</span></label>
                                                        <input
                                                    ...
                                                    <div class="verify-discord">
                                                        <div class="mb-3">
                                                            @if($credits_reward_after_verify_discord)
                                                                <p>{{ __('By verifying your discord account, you receive an extra') }}
                                                                    <b><i class="fa fa-coins mx-1"></i>{{$credits_reward_after_verify_discord}}</b> {{ __('credits and increased server limit') }}
                                                                </p>
                                                            @endif
                                                        </div>
                                                    </div>
